    ...
    <Container>
      <div className="inner-layout">
        ...
        <Text type="p4" margin={'0 0 12px 0'} color="primary">
          ...
          personally or on behalf of an entity (“you”) and Onbloc Co., Ltd. ("Company," “we," “us,"
          or “our”), concerning your access to and use of the http://www.gnoscan.io website as well
          ...
          South Korea and have our registered office at 223-5, Itaewon-ro, Yongsan-gu, Seoul 04349.
          Our VAT number is 658-87-02642. You agree that by accessing the Site, you have read,
          understood, and agreed to be bound by all of these terms of service. IF YOU DO NOT AGREE
          WITH ALL OF THESE TERMS OF SERVICE, THEN YOU ARE EXPRESSLY PROHIBITED FROM USING THE SITE
        ...
        <Text type="p4" margin={'0 0 12px 0'} color="primary">
          ...
          continued use of the Site after the date such revised terms of service are posted. The
          information provided on the Site is not intended for distribution to or use by any person
        ...
        <Text type="p4" margin={'0 0 12px 0'} color="primary">
          <Text type="p4" margin={'0 0 12px 0'} color="primary">
            ...
            and agree to these terms of service prior to you using the Site.
          </Text>
          <Text className="bold" type="h5" margin={'24px 0 18px 0'} color="primary">
          ...
          <Text type="p4" margin={'0 0 12px 0'} color="primary">
            ...
            intellectual property rights and unfair competition laws of South Korea, international
            ...
            provided in these terms of service, no part of the Site and no Content or Marks may be
          ...
          <Text type="p4" margin={'0 0 12px 0'} color="primary">
            ...
            you agree to comply with these terms of service; (2) you are not a minor in the
            jurisdiction in which you reside, or if a minor, you have received parental permission
            to use the Site; (3) you will not use the Site for any illegal or unauthorized purpose;
            and (4) your use of the Site will not violate any applicable law or regulation.
          </Text>
          <Text type="p4" margin={'0 0 12px 0'} color="primary">
          ...
          <Text type="p4" margin={'0 0 12px 0'} color="primary">
            Any use of the Site in violation of the foregoing violates these terms of service and
          ...
          <Text type="p4" margin={'0 0 12px 0'} color="primary">
            ...
            you do so at your own risk, and you should be aware these terms of service no longer
          ...
          <Text type="p4" margin={'0 0 12px 0'} color="primary">
            ...
            these terms of service; (2) take appropriate legal action against anyone who, in our
            sole discretion, violates the law or these terms of service, including without
          ...
          <Text type="p4" margin={'0 0 12px 0'} color="primary">
            ...
            Site.WITHOUT LIMITING ANY OTHER PROVISION OF THESE TERMS OF SERVICE, WE RESERVE THE
            RIGHT TO, IN OUR SOLE DISCRETION AND WITHOUT NOTICE OR LIABILITY, DENY ACCESS TO AND USE
            OF THE SITE(INCLUDING BLOCKING CERTAIN IP ADDRESSES), TO ANY PERSON FOR ANY REASON OR
            FOR NO REASON, INCLUDING WITHOUT LIMITATION FOR BREACH OF ANY REPRESENTATION, WARRANTY,
            OR COVENANT CONTAINED IN THESE terms of service OR OF ANY APPLICABLE LAW OR
            REGULATION.WE MAY TERMINATE YOUR USE OR PARTICIPATION IN THE SITE OR DELETE ANY CONTENT
          ...
          <Text type="p4" margin={'0 0 12px 0'} color="primary">
            ...
            downtime or discontinuance of the Site.Nothing in these terms of service will be
          ...
          <Text type="p4" margin={'0 0 12px 0'} color="primary">
            These Terms shall be governed by and defined following the laws of South Korea.Onbloc
            Co., Ltd.and yourself irrevocably consent that the courts of South Korea shall have
          ...
          <Text type="p4" margin={'0 0 12px 0'} color="primary">
            ...
            resolved by the law of South Korea.The number of arbitrators shall be three(3).The seat,
            or legal place, of arbitration shall be Seoul, South Korea.The language of the
            proceedings shall be Korean.The governing law of the contract shall be the substantive
            law of South Korea.
          </Text>
          <Text className="bold" type="p4" margin={'0 0 12px 0'} color="primary">
            Restrictions
        ...
        <Text type="p4" margin={'0 0 12px 0'} color="primary">
          ...
          DAMAGES.NOTWITHSTANDING ANYTHING TO THE CONTRARY CONTAINED HEREIN, OUR LIABILITY TO YOU
          FOR ANY CAUSE WHATSOEVER AND REGARDLESS OF THE FORM OF THE ACTION, WILL AT ALL TIMES BE
          LIMITED TO THE AMOUNT PAID, IF ANY, BY YOU TO US DURING THE SIX(6) MONTH PERIOD PRIOR TO
        ...
        <Text type="p4" margin={'0 0 12px 0'} color="primary">
          ...
          in any jurisdiction which require an original signature or delivery or retention of non -
        ...
        <Text type="p4" margin={'0 0 12px 0'} color="primary">
          ...
          us.Our failure to exercise or enforce any right or provision of these terms of service
          shall not operate as a waiver of such right or provision.These terms of service operate to
          ...
          provision or part of a provision of these terms of service is determined to be unlawful,
          ...
          relationship created between you and us as a result of these terms of service or use of
          the Site.You agree that these terms of service will not be construed against us by virtue
