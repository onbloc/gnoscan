  ...
  return (
    <S.Container>
      <div className="inner-layout">
        <Text type="h2" margin={"0 0 12px 0"} color="primary">
          Terms of Service
        </Text>
        <Text type="p4" margin={"0 0 40px 0"} color="primary">
        ...
        <Text type="p4" margin={"0 0 12px 0"} color="primary">
          ...
          behalf of an entity (“you”) and Onbloc Co., Ltd. ("Company," “we," “us," or “our”), concerning your access to
          and use of the http://www.gnoscan.io website as well as any other media form, media channel, mobile website or
          mobile application related, linked, or otherwise connected thereto (collectively, the “Site”). We are
          registered in South Korea and have our registered office at 223-5, Itaewon-ro, Yongsan-gu, Seoul 04349. Our
          VAT number is 658-87-02642. You agree that by accessing the Site, you have read, understood, and agreed to be
          bound by all of these terms of service. IF YOU DO NOT AGREE WITH ALL OF THESE TERMS OF SERVICE, THEN YOU ARE
        ...
        <Text type="p4" margin={"0 0 12px 0"} color="primary">
          ...
          modifications to these terms of service from time to time. We will alert you about any changes by updating the
          “Last updated” date of these terms of service, and you waive any right to receive specific notice of each such
          ...
          the changes in any revised terms of service by your continued use of the Site after the date such revised
          terms of service are posted. The information provided on the Site is not intended for distribution to or use
        ...
        <Text type="p4" margin={"0 0 12px 0"} color="primary">
          <Text type="p4" margin={"0 0 12px 0"} color="primary">
            ...
            minor, you must have your parent or guardian read and agree to these terms of service prior to you using the
            Site.
          </Text>
          <Text className="bold" type="h5" margin={"24px 0 18px 0"} color="primary">
          ...
          <Text type="p4" margin={"0 0 12px 0"} color="primary">
            ...
            various other intellectual property rights and unfair competition laws of South Korea, international
            copyright laws, and international conventions. The Content and the Marks are provided on the Site “AS IS”
            for your information and personal use only. Except as expressly provided in these terms of service, no part
            of the Site and no Content or Marks may be copied, reproduced, aggregated, republished, uploaded, posted,
          ...
          <Text type="p4" margin={"0 0 12px 0"} color="primary">
            ...
            with these terms of service; (2) you are not a minor in the jurisdiction in which you reside, or if a minor,
            you have received parental permission to use the Site; (3) you will not use the Site for any illegal or
            unauthorized purpose; and (4) your use of the Site will not violate any applicable law or regulation.
          </Text>
          <Text type="p4" margin={"0 0 12px 0"} color="primary">
          ...
          <Text type="p4" margin={"0 0 0 0"} color="primary">
          ...
          <Text type="p4">{" · Disparage, tarnish, or otherwise harm, in our opinion, us and/or the Site."}</Text>
          <Text type="p4">
          ...
          <Text type="p4">{" · Use the Site in a manner inconsistent with any applicable laws or regulations."}</Text>
          <Text type="p4">{" · Engage in unauthorized framing of or linking to the Site."}</Text>
          <Text type="p4">
            {
              " · Upload or transmit (or attempt to upload or to transmit) viruses, Trojan horses, or other material, including excessive use of capital letters and spamming (continuous posting of repetitive text), that interferes with any party’s uninterrupted use and enjoyment of the Site or modifies, impairs, disrupts, alters, or interferes with the use, features, functions, operation, or maintenance of the Site."
            }
          </Text>
          <Text type="p4">{" · Delete the copyright or other proprietary rights notice from any Content."}</Text>
          <Text type="p4">
            {
          ...
          <Text type="p4">
            {
              " · Support or engage in any illegal activities including, but not limited to, illegal gambling, fraud, money laundering, or terrorist activities"
            }
          </Text>
          <Text className="bold" type="h5" margin={"24px 0 18px 0"} color="primary">
            ...
            <Text type="p4">{" · Your Contributions are not false, inaccurate, or misleading."}</Text>
            <Text type="p4">
              {
            ...
            <Text type="p4">{" · Your Contributions do not violate any applicable law, regulation, or rule."}</Text>
            <Text type="p4">
          ...
          <Text type="p4" margin={"0 0 12px 0"} color="primary">
            ...
            following the terms of the Privacy Policy and your choices (including settings). By submitting suggestions
            or other feedback regarding the Site, you agree that we can use and share such feedback for any purpose
          ...
          <Text type="p4" margin={"0 0 12px 0"} color="primary">
            ...
            risk, and you should be aware these terms of service no longer govern. You should review the applicable
          ...
          <Text type="p4" margin={"0 0 12px 0"} color="primary">
            ...
            TERMINATE YOUR USE OR PARTICIPATION IN THE SITE OR DELETE ANY CONTENT OR INFORMATION THAT YOU POSTED AT ANY
          ...
          <Text type="p4" margin={"0 0 12px 0"} color="primary">
            ...
            discontinuance of the Site.Nothing in these terms of service will be construed to obligate us to maintain
          ...
          <Text type="p4" margin={"0 0 12px 0"} color="primary">
            These Terms shall be governed by and defined following the laws of South Korea.Onbloc Co., Ltd.and yourself
          ...
          <Text className="bold" type="p4" margin={"0 0 12px 0"} color="primary">
            Informal Negotiations
          </Text>
          <Text type="p4" margin={"0 0 12px 0"} color="primary">
            To expedite resolution and control the cost of any dispute, controversy, or claim related to these terms of
            service(each "Dispute" and collectively, the “Disputes”) brought by either you or us(individually, a “Party”
          ...
          <Text type="p4" margin={"0 0 12px 0"} color="primary">
            ...
            existence, validity, or termination, shall be referred to and finally resolved by the law of South Korea.The
            number of arbitrators shall be three(3).The seat, or legal place, of arbitration shall be Seoul, South
            Korea.The language of the proceedings shall be Korean.The governing law of the contract shall be the
        ...
        <Text type="p4" margin={"0 0 12px 0"} color="primary">
          ...
          OR CESSATION OF TRANSMISSION TO OR FROM THE SITE, (5) ANY BUGS, VIRUSES, TROJAN HORSES, OR THE LIKE WHICH MAY
          ...
          PARTY PROVIDERS OF PRODUCTS OR SERVICES.AS WITH THE PURCHASE OF A PRODUCT OR SERVICE THROUGH ANY MEDIUM OR IN
        ...
        <Text type="p4" margin={"0 0 12px 0"} color="primary">
          ...
          (1) use of the Site; (2) breach of these terms of service; (3) any breach of your representations and
          warranties set forth in these terms of service; (4) your violation of the rights of a third party, including
          but not limited to intellectual property rights; or(5) any overt harmful act toward any other user of the Site
        ...
        <Text type="p4" margin={"0 0 12px 0"} color="primary">
          These terms of service and any policies or operating rules posted by us on the Site or in respect to the Site
          constitute the entire agreement and understanding between you and us.Our failure to exercise or enforce any
          right or provision of these terms of service shall not operate as a waiver of such right or provision.These
          terms of service operate to the fullest extent permissible by law.We may assign any or all of our rights and
          ...
          provision is deemed severable from these terms of service and does not affect the validity and enforceability
          of any remaining provisions.There is no joint venture, partnership, employment or agency relationship created
          between you and us as a result of these terms of service or use of the Site.You agree that these terms of
          service will not be construed against us by virtue of having drafted them.You hereby waive any and all
          defenses you may have based on the electronic form of these terms of service and the lack of signing by the
