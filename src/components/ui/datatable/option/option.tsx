...
export const headerOptionByHeader = <T extends { [key in string]: any }>(header: Header<T>): Option<T> => {
  return {
...
export const dataOptionByHeader = <T extends { [key in string]: any }>(header: Header<T>): Option<T> => {
  return {
    themeMode: header.themeMode ?? "light",
