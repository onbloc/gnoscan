/* eslint-disable */
// Vendored verbatim from gnolang/tm2-js-client#284 src/proto/tm2/tx.ts (e8a43a05) until it is released upstream.
...
export const TxSignature: MessageFns<TxSignature> = {
  ...
  fromPartial<I extends Exact<DeepPartial<TxSignature>, I>>(object: I): TxSignature {
    const message = createBaseTxSignature();
    message.pub_key =
      object.pub_key !== undefined && object.pub_key !== null ? Any.fromPartial(object.pub_key) : undefined;
