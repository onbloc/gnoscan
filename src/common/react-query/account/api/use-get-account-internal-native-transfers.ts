...
export const useGetAccountInternalNativeTransfers = (
  ...
  return useApiRepositoryInfiniteQuery<GetAccountTransactionsResponse, Error, typeof apiAccountRepository>(
    [QUERY_KEY.getAccountInternalNativeTransfers, params],
    ...
    (repository, pageParam) => {
      ...
      return repository.getAccountInternalNativeTransfers({
        ...params,
